...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "E:\\tool\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "D:\\develop\\upload\\1_2.avi";
    String mp4_name = "test1.mp4";
    String mp4folder_path = "D:\\develop\\upload\\";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //转换后mp4文件的路径
        String mp4_path = "D:\\develop\\upload";
        //创建工具类对象
